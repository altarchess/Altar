...
*/
	...
	getTuneVector()->MODIF[1] = 54;//PAWNMIDDLEGAMESPACE
	getTuneVector()->MODIF[2] = 84;//ISOLANIEFFECT
	getTuneVector()->MODIF[3] = 77;//DOUBLEDEFFECT
	getTuneVector()->MODIF[4] = 58;//BISHOP MIDDLEGAME MOBILITY
	...
	getTuneVector()->MODIF[9] = 72;// ROOK MIDDLEGAME MOB
	getTuneVector()->MODIF[10] = 57;//ROOK ENDGAME MOB
	getTuneVector()->MODIF[11] = 1;//QUEEN MIDDLEGAME MOB
	getTuneVector()->MODIF[12] = 119;//QUEEN ENDGAME MOB
	getTuneVector()->MODIF[13] = 402;//BISHOP PAIR BONUS
	getTuneVector()->MODIF[14] = -30; //KNIGHT PAIR BONUS
	getTuneVector()->MODIF[15] = 72;// king defenders count
	getTuneVector()->MODIF[16] = 0;//kingShield count
	getTuneVector()->MODIF[17] = 12;//kingPSQTMIDDLEGAME
	getTuneVector()->MODIF[18] = 221;// kingPSQTENDGAME
	getTuneVector()->MODIF[19] = 79; //atcounter
	getTuneVector()->MODIF[20] = pawnMiddleGame;
	getTuneVector()->MODIF[21] = knightMiddleGame;
	getTuneVector()->MODIF[22] = bishopMiddleGame;
	getTuneVector()->MODIF[23] = rookMiddleGame;
	...
	getTuneVector()->MODIF[28] = rookEndGame;
	getTuneVector()->MODIF[29] = queenEndGame;
	getTuneVector()->MODIF[30] = 34; //weakPenalty
	getTuneVector()->MODIF[31] = 40; //openfileweakPenalty
	getTuneVector()->MODIF[32] = 14; //openfileweakPenaltyRook
	getTuneVector()->MODIF[33] = 80; //protectedPawn
	getTuneVector()->MODIF[34] = 17; //bishopEnemyTerritory
	getTuneVector()->MODIF[35] = 322; //passedPawnBonus
	getTuneVector()->active = 36;
