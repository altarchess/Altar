...
*/
    ...
    getTuneVector()->MODIF[0] = 135;// PAWNENDGAMESPACE
	getTuneVector()->MODIF[1] = 52;//PAWNMIDDLEGAMESPACE
	getTuneVector()->MODIF[2] = 77;//ISOLANIEFFECT
	getTuneVector()->MODIF[3] = 95;//DOUBLEDEFFECT
	getTuneVector()->MODIF[4] = 67;//BISHOP MIDDLEGAME MOBILITY
	getTuneVector()->MODIF[5] = 84;//BISHOP ENDGAME MOBILITY
	...
	getTuneVector()->MODIF[9] = 73;// ROOK MIDDLEGAME MOB
	getTuneVector()->MODIF[10] = 56;//ROOK ENDGAME MOB
	getTuneVector()->MODIF[11] = 4;//QUEEN MIDDLEGAME MOB
	getTuneVector()->MODIF[12] = 117;//QUEEN ENDGAME MOB
	getTuneVector()->MODIF[13] = 409;//BISHOP PAIR BONUS
	getTuneVector()->MODIF[14] = -19; //KNIGHT PAIR BONUS
	getTuneVector()->MODIF[15] = 71;// king defenders count
	getTuneVector()->MODIF[16] = 0;//kingShield count
	getTuneVector()->MODIF[17] = 12;//kingPSQTMIDDLEGAME
	getTuneVector()->MODIF[18] = 224;// kingPSQTENDGAME
	getTuneVector()->MODIF[19] = 74; //atcounter
	getTuneVector()->MODIF[20] = pawnMiddleGame;
	getTuneVector()->MODIF[21] = knightMiddleGame;
	getTuneVector()->MODIF[22] = bishopMiddleGame;
	getTuneVector()->MODIF[23] = rookMiddleGame;
	...
	getTuneVector()->MODIF[28] = rookEndGame;
	getTuneVector()->MODIF[29] = queenEndGame;
	getTuneVector()->MODIF[30] = -31; //weakPenalty
	getTuneVector()->MODIF[31] = 126; //openfileweakPenalty
	getTuneVector()->MODIF[32] = 40; //openfileweakPenaltyRook
	getTuneVector()->MODIF[33] = 58; //protectedPawn
	getTuneVector()->MODIF[34] = 0; //bishopEnemyTerritory
	getTuneVector()->active = 35;
